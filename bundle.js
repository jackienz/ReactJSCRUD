...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _profilePage = __webpack_require__(27);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ProfileTableList = __webpack_require__(28);

	var _ProfileTableList2 = _interopRequireDefault(_ProfileTableList);
	...
	var ProfilePage = function (_Component) {
	  ...
	  _createClass(ProfilePage, [{
	    key: 'onhandlChange',
	    value: function onhandlChange(e) {
	    ...
	    key: 'updateRecord',
	    value: function updateRecord(index, firstName, lastName, gender, over18) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'firstName', id: 'firstName', placeholder: 'First Name', value: this.state.firstName })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	            ...
	            _react2.default.createElement('input', { className: 'form-control', type: 'text', name: 'lastName', placeholder: 'Last Name', value: this.state.lastName })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'form-group' },
	            _react2.default.createElement(
	              'select',
	              { className: 'form-control', value: this.state.gender, name: 'gender' },
	              _react2.default.createElement(
	                'option',
	                { value: 'please' },
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              null,
	              'Over 18 ',
	              _react2.default.createElement('input', { type: 'checkbox', name: 'over18', value: this.state.over18, checked: this.state.over18 })
	            )
	          ),
	        ...
	        _react2.default.createElement(_ProfileTableList2.default, { profiles: this.state.profiles, deleteRecord: function deleteRecord() {
	            return _this2.deleteRecord();
	          }, updateRecord: function updateRecord(index, firstName, lastName, gender, over18) {
	            return _this2.updateRecord(index, firstName, lastName, gender, over18);
	          } }),
	        _react2.default.createElement('br', null)
	      );
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ProfileTableList = function (_React$Component) {
	  _inherits(ProfileTableList, _React$Component);

	  function ProfileTableList(props) {
	    _classCallCheck(this, ProfileTableList);

	    var _this = _possibleConstructorReturn(this, (ProfileTableList.__proto__ || Object.getPrototypeOf(ProfileTableList)).call(this, props));

	    _this.toggleEditRecord = function (index, firstName, lastName, gender, over18) {
	    ...
	    _this.cancelEditRecord = function (index) {
	      _this.setState({
	        editRow: '',
	        firstName: '',
	        lastName: '',
	  ...
	  _createClass(ProfileTableList, [{
	    key: 'saveEditRecord',
	    value: function saveEditRecord(index) {
	    ...
	    value: function render() {
	      ...
	      var profilesData = this.props.profiles.map(function (profile, index) {
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                { className: 'btn btn-secondary', onClick: function onClick() {
	                    return self.cancelEditRecord(index);
	                  } },
	                'Cancel'
	              ),
	              _react2.default.createElement(
	                ...
	                { className: 'btn btn-success', onClick: function onClick() {
	                    return self.saveEditRecord(index);
	                  } },
	                'Save'
	              )
	            )
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                { className: 'btn btn-danger', onClick: function onClick() {
	                    return self.props.deleteRecord(index);
	                  } },
	                'Delete'
	              ),
	              _react2.default.createElement(
	                ...
	                { className: 'btn btn-info', onClick: function onClick() {
	                    return self.toggleEditRecord(index, profile.firstName, profile.lastName, profile.gender, profile.over18);
	                  } },
	                'Edit'
	              )
	            )
	...
	exports.default = ProfileTableList;
